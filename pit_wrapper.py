...
class PITLossWrapper(nn.Module):
    ...
    def __init__(self, loss_func, pit_from="pw_mtx", perm_reduce=None, th_db=50):
        super().__init__()
    ...
    def forward(self, est_targets, targets, return_est=False, reduce_kwargs=None, reduction=True, **kwargs):
        ...
        if self.pit_from == "pw_mtx":
            ...
            min_loss = min_loss[min_loss > self.th_db]
            if reduction:
